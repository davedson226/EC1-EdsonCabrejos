...
import com.example.edsoncabrejos.service.UniversidadService;
...
public class UniversidadController {
	...
	public ResponseEntity<Void> editar(@RequestBody Universidad universidad){
		...
		Universidad u = service.obtenerU(universidad.getIdUniversidad());
		if(u != null) {
			service.actualizarU(universidad);
